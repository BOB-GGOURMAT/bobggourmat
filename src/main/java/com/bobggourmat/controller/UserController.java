...
public class UserController {
	...
	// 
	@GetMapping(value = "/updateIconOk")
	public String updateIconOk() {
		return "redirect:/";
	}

	@PostMapping(value = "/updateIconOk")
	public String updateIconOk(@ModelAttribute UserVO userVO, HttpSession session) {
		log.info("UserController updateIconOk 호출:" + userVO);
		
		UserVO userinfo = userService.updateIcon(userVO);
		session.setAttribute("userinfo", userinfo);
